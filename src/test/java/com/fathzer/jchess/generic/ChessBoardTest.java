...
class ChessBoardTest {
	...
	void pawnMoveTest() {
		...
		// Test promotion
		assertEquals(Color.BLACK, copy.getActiveColor());
		copy.move(new MyMove("g2","h1",Piece.BLACK_QUEEN));
		...
		board.move(new MyMove("b7","b8", Piece.WHITE_QUEEN));
	...
	void testZobristKey() {
		...
		board.move(new MyMove("a3","c4"));
		assertEquals(FENParser.from("rnbqkbnr/pppppppp/8/1B6/2N5/3PPN2/PPPQBPPP/R3K2R b KQkq - 0 1").getKey(), board.getKey());
		board.move(new MyMove("g8","f6"));
		board.move(new MyMove("c4","a3"));
		board.move(new MyMove("f6","g8"));
		assertEquals(initial, board.getKey());
		
		// Test castling erase
		// 1 - Rook move
		board.move(new MyMove("h1","g1"));
		board.move(new MyMove("g8","f6"));
		board.move(new MyMove("g1","h1"));
		board.move(new MyMove("f6","g8"));
		...
		board.move(new MyMove("e1","d1"));
		board.move(new MyMove("g8","f6"));
		board.move(new MyMove("d1","e1"));
		board.move(new MyMove("f6","g8"));
		...
		board.move(new MyMove("h7", "h8", Piece.WHITE_QUEEN));
	...
	private static class MyMove implements Move {
		...
		public MyMove(String from, String to, Piece promoted) {
